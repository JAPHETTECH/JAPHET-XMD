...
async function startJaphettech() {
  ...
  const client = JaphetConnect({
    ...
    browser: ["𝗝𝗔𝗣𝗛𝗘𝗧-𝗫𝗠𝗗-𝗔𝗜", "Safari", "5.1.7"],
    auth: state,
  ...
  if (autobio === 'TRUE') {
    setInterval(() => {
      ...
      client.updateProfileStatus(
        `📅 𝗗𝗔𝗧𝗘/𝗧𝗜𝗠𝗘 ⌚️  ${date.toLocaleString('en-US', { timeZone: 'Africa/Mwanza' })}  ⏰️  ⏰️  ${date.toLocaleString('en-US', { weekday: 'long', timeZone: 'Africa/Mwanza'})}. 𝗝𝗔𝗣𝗛𝗘𝗧-𝗫𝗠𝗗 𝗜𝗦 𝗖𝗨𝗥𝗥𝗘𝗡𝗧𝗟𝗬  𝗔𝗡𝗗 𝗥𝗨𝗡𝗡𝗜𝗡𝗚⚡.`
      );
    }, 10 * 1000);
  }
 ...
 client.ev.on('call', async (callData) => {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Congrats, 𝗝𝗔𝗣𝗛𝗘𝗧-𝗫𝗠𝗗 𝗛𝗔𝗦 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟𝗟𝗬 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗧𝗢 𝗧𝗛𝗜𝗦 𝗦𝗘𝗥𝗩𝗘𝗥", "green"));
